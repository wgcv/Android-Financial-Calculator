	...
	public void buttonCalc() {
		calc.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				...
				n = (EditText) getActivity().findViewById(R.id.pvann_n);
				...
				//if all is well, do respective calculation
					...
					case 1:// pv
						...
						double result1 = (cf1/(r1/n1))*(1-(Math.pow(1+(r1/n1),-(t1*n1))));
					...
					case 2:// cf
						...
						double result2 = (pv2*(r2/n2))/(1-(Math.pow(1+(r2/n2),-(t2*n2))));
					...
					case 4:// t
                        ...
                        double result4 = (Math.log(1/(1-(pv4*(r4/n4)/cf4))))/(Math.log(1 + (r4/n4)))/n4;
