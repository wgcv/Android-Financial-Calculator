	...
	public void buttonCalc() {
		calc.setOnClickListener(new OnClickListener() {			
			...
			t = (EditText) getActivity().findViewById(R.id.fvanndue_t);
				n = (EditText) getActivity().findViewById(R.id.fvanndue_n);
			...
			if (t.getText().toString().equals("")){emptyfields ++;choice = 4;}
				...
				case 1://fv
					...
					double result1 = (cf1/(r1/n1))*(Math.pow(1+(r1/n1), n1*t1)-1)*(1+(r1/n1));
				...
				case 2://cf
					...
					double result2 = (fv2*(r2/n2))/((Math.pow(1+(r2/n2), n2*t2)-1)*(1+(r2/n2)));
				...
				//	double result4 = (Math.log(	((fv4*r4/cf4)/(1+r4))+1))/(Math.log(1+r4));
					double result4 = Math.log(((fv4*(r4/n4)))/(cf4*(1+(r4/n4)))+1);
